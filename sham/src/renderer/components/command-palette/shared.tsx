...
export const commands: Command[] = [
  ...
  { id: 'editor.split', label: 'Editor: Toggle Split', icon: 'columns', shortcut: ['Ctrl', '\\'], category: 'Editor' },
  { id: 'editor.diff', label: 'Editor: Toggle Diff View', icon: 'gitCompare', shortcut: ['Ctrl', 'Alt', 'D'], category: 'Editor' },
  { id: 'editor.wrap', label: 'Editor: Toggle Word Wrap', icon: 'wrapText', shortcut: ['Ctrl', 'Shift', 'W'], category: 'Editor' },
  { id: 'editor.copyPath', label: 'Editor: Copy File Path', icon: 'copy', category: 'Editor' },
