...
<body>
  ...
  context.subscriptions.push(visualizerCmd, policyCmd, timelinesCmd, policiesCmd, contractsCmd, vaultsCmd, agentsCmd, diffCmd, renameCmd, copyCmd, statsCmd, templateCmd, moveCmd, searchCmd, formatCmd, lintCmd, testCmd, visualizeCmd, graphCmd);
}
